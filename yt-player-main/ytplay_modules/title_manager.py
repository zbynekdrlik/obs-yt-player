...
def schedule_title_show(video_info):
    ...
    # Import here to avoid circular dependency
    from ytplay_modules.opacity_control import set_current_opacity, update_text_opacity
    from ytplay_modules.media_control import update_text_source_content
...
def schedule_title_clear_from_current(remaining_ms):
    ...
    if clear_in_ms > 0:
        ...
        # Import here to avoid circular dependency
        from ytplay_modules.opacity_control import get_current_opacity, fade_out_text
...
def update_text_source(song, artist, gemini_failed=False):
    ...
    """
    # Import here to avoid circular dependency
    from ytplay_modules.opacity_control import get_current_opacity, set_pending_text, fade_out_text, fade_in_text
    from ytplay_modules.media_control import update_text_source_content

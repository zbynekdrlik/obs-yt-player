...
2. Verify all properties appear correctly
3. Check cache directory field is editable
4. Verify script loads without errors
5. Ensure default values are set
6. Check default cache: `<location>/<name>-cache`
7. Test property persistence after restart
8. Verify scene name matches script name
9. Check log output format
10. **Verify version shows as 1.0.0**

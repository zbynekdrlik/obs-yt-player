...
```
obs-scripts/
├── ytplay.py              # Minimal main script (~5KB)
├── ytfast.py              # Just a copy of ytplay.py
├── yt_worship.py          # Another copy
...
- Use script filename for scene name
...
5. **Backwards Compatibility**: Migration path for existing users

## Next Steps

1. Create proof-of-concept ultra-minimal main script
2. Test state isolation with 3 instances
3. Gradually migrate functionality to shared modules
4. Extensive testing with multiple scenarios

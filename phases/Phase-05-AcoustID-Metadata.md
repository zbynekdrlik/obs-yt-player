...
- Use valid public API key: `VEbUsHXC`
...
def query_acoustid(fingerprint, duration):
    ...
    try:
        ...
        req.add_header('User-Agent', 'OBS-YouTube-Player/1.5.0')
...
ACOUSTID_API_KEY = "VEbUsHXC"  # Valid public API key for AcoustID
...
- Valid API key required (use `VEbUsHXC`)
...
- [ ] Add ACOUSTID_API_KEY and ACOUSTID_ENABLED constants

# Phase 06 – iTunes Metadata Search
...
## Version Increment
**This phase adds new features** → Increment MINOR version (e.g., from 1.4.0 to 1.5.0)
...
> *"Add iTunes metadata search as secondary source (Phase 6)"*

*After verification, proceed to Phase 07 for title parser fallback.*

...
from ytfast_modules.config import SCRIPT_NAME, DEFAULT_CACHE_DIR
...
# For compatibility with old import names
init_logger = lambda: None  # No-op, initialization happens automatically
close_logger = cleanup_logging
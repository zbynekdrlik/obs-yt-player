...
SCRIPT_VERSION = "3.5.7"  # Added configuration warnings in script properties UI
...
# DEFAULT_CACHE_DIR is determined in the main script based on SCRIPT_NAME
...
# SCENE_NAME is determined by SCRIPT_NAME in the main script

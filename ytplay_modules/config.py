...
DEFAULT_CACHE_DIR = ""  # Will be set dynamically based on script name
...
# OBS Source names (scene name will be dynamic based on script name)
...
TARGET_LUFS = -14.0  # Target loudness for normalization
